...
## for bTagStrategy in ["Incl","FourPlusTags","ThreeTags","TwoTags"]:
 for Region in ["Resolved_LepN_SR"]:
  for btagStrategy in ["TwoTags"]:
      ...
      file1       = TFile.Open("../PlotFiles/" + files["sig_Hplus_Wh_m400-0"],"READ")
      ...
      file6	  = TFile.Open("../PlotFiles/" + files["sig_Hplus_Wh_m800-0"],"READ")
      ...
      file7	  = TFile.Open("../PlotFiles/" + files["sig_Hplus_Wh_m1600-0"],"READ")
      ...
      h_ttbar_background = dir2.Get("ttbarSherpa_"+HistoName+"_"+Region+"_"+btagStrategy+"_Nominal")
      ...
      h_other_background = h_singleTop_background + h_diboson_background + h_W_background
      ...
      leg.AddEntry(h_sig_Hplus_m400,    "H^{+}#rightarrow hW^{+} (m_{H^{+}} = 400GeV)","L")
      leg.AddEntry(h_sig_Hplus_m800,    "H^{+}#rightarrow hW^{+} (m_{H^{+}} = 800GeV)","L")
      leg.AddEntry(h_sig_Hplus_m1600,   "H^{+}#rightarrow hW^{+} (m_{H^{+}} = 1600GeV)","L")
      ...
      c1.Update()
      c1.RedrawAxis()
      c1.SaveAs("../Plots/ShapePlot_%s_lvbb.pdf" % (HistoName+"_"+btagStrategy+"_"+hmlb+"-"+hmub+"-"+wmlb+"-"+wmub))
