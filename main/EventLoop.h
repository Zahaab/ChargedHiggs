...
EventLoop::~EventLoop()
{
   ...
   delete h_NFjets;
   delete h_Mwt;
   delete h_MinDeltaPhiJETMET;
   delete h_HT;
   delete h_HT_bjets;
   delete h_HT_bjets_Lepton_Pt;
   delete h_DeltaPhi_HW;
   delete h_maxMVAResponse;
   delete h_pTH;
   delete h_pTH_over_mVH;
   delete h_pTWplus;
   delete h_pTW_over_mVH;
   delete h_pTWminus;
   delete h_mH;
   delete h_mWplus;
   delete h_tagCategory;
   delete h_mass_resolution;
   delete h_MET_over_sqrtHT;
   delete h_m_NTags_trkJ;
