...
public:
   ...
   Float_t testTally3 = 0.0;
   Float_t testTally4 = 0.0;
   Float_t testTally5 = 0.0;
   Float_t testTally6 = 0.0;
   Float_t testTally6a = 0.0;
   Float_t testTally7 = 0.0;
   Float_t testTally8 = 0.0;
   Float_t testTally9 = 0.0;
   Float_t testTally10 = 0.0;
   Float_t testTally10a = 0.0;
   Float_t testTally11 = 0.0;
   Float_t testTally12 = 0.0;
   Float_t testTally13 = 0.0;
   Float_t testTally14 = 0.0;
   Float_t testTally15 = 0.0;
...
EventLoop::~EventLoop()
{
   Float_t CF_total = m_TotalEvents.jjbb_WeightedTotal() + m_TotalEvents.lvbb_WeightedTotal();
   std::cout << "Start_events"
             << "\n"
             << "After_Lepton"
             << "\n"
             << "After_Setjet"
             ...
             << testTally3 << "\n"
             << CF_total << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() << "\n"
             << testTally4 << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal()
             << "\n"
             << testTally5 << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    m_ChannelFlexCutFlow.jjbb_WeightedTotal() - m_ChannelFlexCutFlow.lvbb_WeightedTotal()
             << "\n"
             << testTally6 << "\n"
             << testTally6a << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    m_ChannelFlexCutFlow.jjbb_WeightedTotal() - m_ChannelFlexCutFlow.lvbb_WeightedTotal() -
                    m_PositiveLepWCutflow.jjbb_WeightedTotal() - m_PositiveLepWCutflow.lvbb_WeightedTotal() -
                    m_PositiveLepHiggsPtCutFlow.jjbb_WeightedTotal() - m_PositiveLepHiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_HiggsPtCutFlow.jjbb_WeightedTotal() - m_HiggsPtCutFlow.lvbb_WeightedTotal()
             << "\n"
             << testTally7 << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    ...
                    m_PositiveLepHiggsPtCutFlow.jjbb_WeightedTotal() - m_PositiveLepHiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_HiggsPtCutFlow.jjbb_WeightedTotal() - m_HiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_Higgs_LeptonAngleCutflow.jjbb_WeightedTotal() - m_Higgs_LeptonAngleCutflow.lvbb_WeightedTotal()
             << "\n"
             << testTally8 << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    ...
                    m_HiggsPtCutFlow.jjbb_WeightedTotal() - m_HiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_Higgs_LeptonAngleCutflow.jjbb_WeightedTotal() - m_Higgs_LeptonAngleCutflow.lvbb_WeightedTotal() -
                    m_Wplus_LeptonAngleCutflow.jjbb_WeightedTotal() - m_Wplus_LeptonAngleCutflow.lvbb_WeightedTotal()
             << "\n"
             << testTally9 << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    ...
                    m_Higgs_LeptonAngleCutflow.jjbb_WeightedTotal() - m_Higgs_LeptonAngleCutflow.lvbb_WeightedTotal() -
                    m_Wplus_LeptonAngleCutflow.jjbb_WeightedTotal() - m_Wplus_LeptonAngleCutflow.lvbb_WeightedTotal() -
                    m_Higgs_WplusAngleCutflow.jjbb_WeightedTotal() - m_Higgs_WplusAngleCutflow.lvbb_WeightedTotal()
             << "\n"
             << testTally10 << "\n"
             << testTally10a << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
             ...
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    ...
                    m_PositiveLepWCutflow.jjbb_WeightedTotal() - m_PositiveLepWCutflow.lvbb_WeightedTotal() -
                    m_PositiveLepHiggsPtCutFlow.jjbb_WeightedTotal() - m_PositiveLepHiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_HiggsMassCutFlow.jjbb_WeightedTotal() - m_HiggsMassCutFlow.lvbb_WeightedTotal()
             << "\n"
             << CF_total - m_HadronicCutFlow.jjbb_WeightedTotal() - m_HadronicCutFlow.lvbb_WeightedTotal() -
                    m_LeptonicCutFlow.jjbb_WeightedTotal() - m_LeptonicCutFlow.lvbb_WeightedTotal() -
                    m_ChannelFlexCutFlow.jjbb_WeightedTotal() - m_ChannelFlexCutFlow.lvbb_WeightedTotal() -
                    ...
                    m_PositiveLepHiggsPtCutFlow.jjbb_WeightedTotal() - m_PositiveLepHiggsPtCutFlow.lvbb_WeightedTotal() -
                    m_HiggsMassCutFlow.jjbb_WeightedTotal() - m_HiggsMassCutFlow.lvbb_WeightedTotal() -
                    m_WplusMassCutFlow.jjbb_WeightedTotal() - m_WplusMassCutFlow.lvbb_WeightedTotal()
             << "\n"
             << testTally14 << "\n";
   ...
   std::cout << "lvbb TwoTags "
             ...
             << "jjbb FourPlusTags "
             << "\n"
             << TwoTagHisto["Merged_LepP_SR_TwoTags"][0]->Integral(-1, 30, "") << "\n"
             << TwoTagHisto["Merged_LepN_SR_TwoTags"][0]->Integral(-1, 30, "") << "\n"
             << ThreeTagHisto["Merged_LepP_SR_ThreeTags"][0]->Integral(-1, 30, "") << "\n"
             << ThreeTagHisto["Merged_LepN_SR_ThreeTags"][0]->Integral(-1, 30, "") << "\n"
             << FourTagHisto["Merged_LepP_SR_FourPlusTags"][0]->Integral(-1, 30, "") << "\n"
             << FourTagHisto["Merged_LepN_SR_FourPlusTags"][0]->Integral(-1, 30, "") << "\n";
